...
public class HODLeaveApproval extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hodleave_approval);
        ...
        Query queryComp = FirebaseDatabase.getInstance().getReference("Employee Leaves")
                .orderByChild("dept")
                .equalTo(MyDepartment);

        queryComp.addListenerForSingleValueEvent(valueEventListener);
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            LeaveList adaptor = new LeaveList(HODLeaveApproval.this,leaveList);
...
/*
    ...
    protected void onStart() {
        ...
        databaseLeaves.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                leaveList.clear();
                for(DataSnapshot leaveSnapshot : dataSnapshot.getChildren())
    ...
    */
    ...
    {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Employee Leaves").child(id);
