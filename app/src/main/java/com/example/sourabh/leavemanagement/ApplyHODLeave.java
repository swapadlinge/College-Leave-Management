...
public class ApplyHODLeave extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_hodleave);
    ...
    public void applyLeave()
    {
        ...
        String status = "Pending";
...

            {
                ...
                Toast.makeText(this, "Please Enter HOD Name", Toast.LENGTH_LONG).show();
            }
